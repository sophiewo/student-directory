...
def print_footer(students, letter)
  puts "Overall, we have #{students.count} great students but these are the ones whose name starts with: #{letter}"
end
...
def sort_print_specific_letter(students, letter)
  students.map do |name| name.values[0]
...
print_header(letter)
sort_print_specific_letter(students, letter)
